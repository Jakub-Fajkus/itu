...
var _controllers = __webpack_require__(329);
...
var _DefaultController = __webpack_require__(330);
...
var _BaseController2 = __webpack_require__(331);
    ...
    _lodash2.default.each($('[data-sortable]'), function (el) {
        ...
        $el.sortable(_extends({
            ...
            update: function update() {
                ...
                (0, _ajax.postJSON)(definition.url, data).catch(function () {
                    $el.empty();
